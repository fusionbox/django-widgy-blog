...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogLayout.defaultlayout_ptr'
        db.delete_column(u'widgy_blog_bloglayout', u'defaultlayout_ptr_id')

        # Adding field 'BlogLayout.id'
        db.add_column(u'widgy_blog_bloglayout', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BlogLayout.defaultlayout_ptr'
        db.add_column(u'widgy_blog_bloglayout', u'defaultlayout_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['page_builder.DefaultLayout'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'BlogLayout.id'
        db.delete_column(u'widgy_blog_bloglayout', u'id')
    ...
    models = {
        ...
        u'widgy_blog.bloglayout': {
            'Meta': {'object_name': 'BlogLayout'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blog_bloglayout_set'", 'to': u"orm['auth.User']"}),
