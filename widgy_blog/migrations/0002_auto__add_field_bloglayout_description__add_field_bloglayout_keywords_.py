...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogLayout.description'
        db.add_column(u'widgy_blog_bloglayout', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogLayout.keywords'
        db.add_column(u'widgy_blog_bloglayout', 'keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BlogLayout.page_title'
        db.add_column(u'widgy_blog_bloglayout', 'page_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogLayout.description'
        db.delete_column(u'widgy_blog_bloglayout', 'description')

        # Deleting field 'BlogLayout.keywords'
        db.delete_column(u'widgy_blog_bloglayout', 'keywords')

        # Deleting field 'BlogLayout.page_title'
        db.delete_column(u'widgy_blog_bloglayout', 'page_title')
