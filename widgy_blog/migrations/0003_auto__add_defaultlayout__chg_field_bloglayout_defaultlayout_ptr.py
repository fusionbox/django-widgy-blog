...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'widgy_blog_defaultlayout', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'widgy_blog', ['DefaultLayout'])


        # Changing field 'BlogLayout.defaultlayout_ptr'
        db.alter_column(u'widgy_blog_bloglayout', u'defaultlayout_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['widgy_blog.DefaultLayout'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Deleting model 'DefaultLayout'
        db.delete_table(u'widgy_blog_defaultlayout')


        # Changing field 'BlogLayout.defaultlayout_ptr'
        db.alter_column(u'widgy_blog_bloglayout', u'defaultlayout_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['page_builder.DefaultLayout'], unique=True, primary_key=True))
    ...
    models = {
        ...
        u'widgy_blog.bloglayout': {
            ...
            u'defaultlayout_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['widgy_blog.DefaultLayout']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
